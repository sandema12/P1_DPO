...
public class Encuesta extends Actividad {
    ...
    public Encuesta(String titulo, String descripcion, String objetivo, String dificultad, String tipo,  boolean obligatoria, int duracionMinutos, LocalDate fechaLimite) {
